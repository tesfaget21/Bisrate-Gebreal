<%@ Page Title="" Language="C#" MasterPageFile="~/LookUpMaster.Master" AutoEventWireup="true" CodeBehind="KifyaTypeNames.aspx.cs" Inherits="BGCMS.LookUp.KifyaTypeNames" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:Panel ID="pnlMetedaderia" runat="server" GroupingText="ክፍያ አይነት ስሞች  መመዝገቢያ" 
    ...
    <table class="style1">
            <tr>
                ...
                <td class="style2" style="width: 117px">
                    <asp:Label ID="ለበለ" runat="server" Text="ክፍያ  ስም፡ "></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtKifyaName" runat="server" Width="226px"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td colspan="2">
                    <asp:ListBox ID="lbxKifyaNames" runat="server" Width="470px" 
                        AutoPostBack="True" 
                        onselectedindexchanged="lbxKifyaNames_SelectedIndexChanged"></asp:ListBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
