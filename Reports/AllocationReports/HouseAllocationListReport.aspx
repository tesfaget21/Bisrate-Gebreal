<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HouseAllocationListReport.aspx.cs" Inherits="BGCMS.Reports.HouseAllocationListReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
    <asp:Panel ID="Panel1" runat="server" GroupingText="የቢሮና ማረፊያ ቤት ዝርዝር ሪፖርት" 
                BackColor="#CCCCFF">
        <table class="style1">
            <tr>
                <td class="style9" colspan="2">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<asp:Label 
                        ID="Label2" runat="server" Text="ምደባ አይነት:"></asp:Label>
                    &nbsp;&nbsp;&nbsp;
                </td>
                <td class="style9" colspan="2">
                    <telerik:RadComboBox ID="cbxMedibType" runat="server" 
                        style="margin-left: 0px">
                        <Items>
                            <telerik:RadComboBoxItem runat="server" Text="ሁሉም" Value="0" 
                               />
                            <telerik:RadComboBoxItem runat="server" Text="ቢሮና ልዩ ልዩ አገልግሎቶች" Value="1" 
                               />
                            <telerik:RadComboBoxItem runat="server" Text="ማረፊያ ቤት" Value="2" 
                              />
                           <%-- <telerik:RadComboBoxItem runat="server" Text="ለጊዜው የታገዱ" Value="3" 
                                Owner="cbxAgelglotName" />
