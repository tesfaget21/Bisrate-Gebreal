<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EletKirstinaLIstReport.aspx.cs" Inherits="BGCMS.Reports.EletKirstinaLIstReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
    <asp:Panel ID="Panel1" runat="server" GroupingText="እለት ክርስትና ዝርዝር ሪፖርት" 
                BackColor="#CCCCFF">
        <table class="style1">
            <tr>
            ...
            <tr>
                ...
                <td class="style10" colspan="3">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;<asp:Button 
                        ID="btnGenerateAbalReport" runat="server" onclick="btnGenerateAbalReport_Click" 
                        Text=" ሪፖርት አውጣ" Width="127px" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <tr>
                <td class="style9" colspan="4">
                    <telerik:RadToolTip ID="ttForReport" runat="server" Height="600px" 
                        ...
                        <telerik:ReportViewer ID="rvrAbalList" runat="server" Height="600px" 
               ...
               <%--<tr>
                ...
                <td class="style9" colspan="4">
                    &nbsp;<telerik:ReportViewer ID="rvrAbalList" runat="server" 
                        style="margin-left: 0px" Width="793px">
                    </telerik:ReportViewer>
                </td>
                  </asp:Panel>
            </tr>--%>
                ...
                <td class="style9" colspan="4">
                    &nbsp;<telerik:ReportViewer ID="rvrFamilyList" runat="server" 
                        style="margin-left: 0px" Width="793px">
                    </telerik:ReportViewer>
                </td>
                  </asp:Panel>
