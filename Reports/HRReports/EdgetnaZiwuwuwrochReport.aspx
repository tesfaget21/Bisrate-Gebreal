<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EdgetnaZiwuwuwrochReport.aspx.cs" Inherits="BGCMS.Reports.EdgetnaZiwuwuwrochReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
    <asp:Panel ID="Panel1" runat="server" GroupingText="የአገልጋዮች እድገትና ዝውውሮች ሪፖርት" 
                BackColor="#CCCCFF">
        <table class="style1">
            <tr>
            ...
            <tr>
                <td class="style9" colspan="4">
                    <telerik:RadToolTip ID="ttForReport" runat="server" Height="600px" 
                        ...
                        <telerik:ReportViewer ID="rvrEdgetZiwuwurList" runat="server" Height="600px" 
