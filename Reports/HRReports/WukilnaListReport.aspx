<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WukilnaListReport.aspx.cs" Inherits="BGCMS.Reports.WukilnaListReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
    <asp:Panel ID="Panel1" runat="server" GroupingText="ውክልና መረጃ ሪፖርት" 
                BackColor="#CCCCFF">
        <table class="style1">
            <tr>
            ...
            <tr>
                <td class="style9" colspan="4">
                    &nbsp;<telerik:ReportViewer ID="rvrWuklinaList" runat="server" 
