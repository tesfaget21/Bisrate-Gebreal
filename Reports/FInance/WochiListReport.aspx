<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WochiListReport.aspx.cs" Inherits="BGCMS.Reports.FInance.WochiListReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
    <asp:Panel ID="Panel1" runat="server" GroupingText="የወጪ ዝርዝር ሪፖርት" 
                BackColor="#CCCCFF">
        <table class="style1">
            <tr>
                <td class="style9" colspan="2">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<asp:Label 
                        ID="Label2" runat="server" Text="የወጪ አይነት :"></asp:Label>
                    &nbsp;&nbsp;&nbsp;
                </td>
                <td class="style9" colspan="2">
                    <telerik:RadComboBox ID="cbxWochType" runat="server" 
                        style="margin-left: 0px" AutoPostBack="True" 
                        onselectedindexchanged="cbxKifyaType_SelectedIndexChanged">
                        <Items>
                        
                         <telerik:RadComboBoxItem runat="server" Text="ሁሉም" Value="0" Owner="cbxWochType" />
                        <telerik:RadComboBoxItem runat="server" Text="ግዢ" Value="1" Owner="cbxWochType" />
