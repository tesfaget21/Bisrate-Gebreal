<%@ Page Title="" Language="C#" MasterPageFile="~/ResponsibleConfirmationa.master" AutoEventWireup="true" CodeBehind="BossEletKirstinaConfirmation.aspx.cs" Inherits="BGCMS.Confirmations.BossEletKirstinaConfirmation" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server" GroupingText="የእለት ክርስትና ማረጋገጫ" 
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td class="style11">
                            <asp:ListBox ID="lbxEletKirstinaInformation" runat="server" 
                ...
                <table class="style1">
                    <tr>
                        ...
                        <td class="style37" style="width: 144px">
                            <asp:Label ID="lblBabyName" runat="server" Text="የህፃን ሙሉ  ስም፡ " 
                                style="font-size: small"></asp:Label>
                        </td>
                        <td class="style9">
                            <asp:TextBox ID="txtBabyName" runat="server" AutoPostBack="True" 
                    ...
                    <tr>
                        ...
                        <td class="style37" style="width: 144px">
                            <asp:Label ID="lblBabyKirstinaSim" runat="server" Text="የህፃን ክርስትና  ስም : " 
                                style="font-size: small"></asp:Label>
                        </td>
                        <td class="style9">
                            <asp:TextBox ID="txtBabyKirstinaSim" runat="server" Width="155px" AutoPostBack="True"
                    ...
                    <tr>
                        ...
                        <td class="style37" style="width: 144px">
                            <asp:Label ID="lblRequestDate" runat="server" style="font-size: small" 
                                Text="የተመዘገበበት ቀን : "></asp:Label>
                        </td>
                        <td class="style9">
                            <asp:TextBox ID="txtRequestDate" runat="server" AutoPostBack="True" 
