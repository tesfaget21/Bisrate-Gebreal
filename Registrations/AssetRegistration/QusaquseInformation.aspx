<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QusaquseInformation.aspx.cs" Inherits="BGCMS.Registrations.AssetRegistration.AlbasatInformation" %>
...
<asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" 
        GroupingText="ልዩ ልዩ ቁሳቁሶች  መመዝገቢያ" BackColor="#CCCCFF">
        <table class="style1">
            <tr>
                <td>
                    &nbsp;</td>
                ...
                <td>
                    <telerik:RadComboBox ID="cbxQusType" Runat="server" Height="120px" 
                        EmptyMessage=".ከዚህ ይምረጡ …" Width="236px" 
                        data-validation-engine="validate[required]" 
                        onselectedindexchanged="cbxQusType_SelectedIndexChanged" 
                        AutoPostBack="True">
                    </telerik:RadComboBox>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cbxQusSourceType" Runat="server" 
            ...
            <tr>
                ...
                <td class="style31">
                    <asp:Label ID="Label43" runat="server" Text="ስም/ መጠርያ ፡"></asp:Label>
                </td>
                <td class="style30">
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td class="style29">
                    <asp:Label ID="Label39" runat="server" Text="መለያ/ልዩ ኮድ:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtQusUniqueNumber" runat="server" Width="173px" 
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td class="style29">
                    <asp:Label ID="Label48" runat="server" Text="ብዛት ፡ "></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtQuantity" runat="server" 
                         Height="19px" Width="173px" data-validation-engine="validate[custom[integer]]"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cbxQusQuality" Runat="server" 
                        EmptyMessage=".ከዚህ ይምረጡ …" Height="70px" Width="231px">
                        <Items>
                            <telerik:RadComboBoxItem runat="server" Text="አዲስና በጥሩ ሁኔታ ላይ ያለ " Value="1" />
                            <telerik:RadComboBoxItem runat="server" Text="መካከለኛና ሙሉ አገልግሎት የሚሰጥ" 
                                Value="2" />
                            <telerik:RadComboBoxItem runat="server" Text="አሮጌና መታደስ የሚችል" Value="3" />
                            <telerik:RadComboBoxItem runat="server" Text="አገልግሎት መስጠት የማይችል" Value="4" />
                        </Items>
                    </telerik:RadComboBox>
                </td>
                <td>
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td class="style29">
                    <asp:Label ID="lblRegistrationDate" runat="server" Text="ገቢ የተደረገበት ቀን:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtRecieptDate" runat="server" ClientIDMode="Static" 
                        data-validation-engine="validate[required]" 
                        onclick="alert(getId('txtRecieptDate')))" Width="156px"></asp:TextBox>
                    <asp:Image ID="image4" runat="server" ImageUrl="~/Images/Calendar.png" 
                        meta:resourcekey="Image1Resource1" 
                        onclick="getPosition(this.id),getId('txtRecieptDate')" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                <td>
                    &nbsp;</td>
                <td class="style29">
                    <asp:Label ID="Label46" runat="server" Text="የተመረተበት / የተዘጋጀበትጊዜ: "></asp:Label>
                </td>
                <td>
                  <%--  <telerik:RadDatePicker ID="DateOfFabrication" Runat="server" Height="24px" 
                        Width="149px">
                    ...
                    <asp:TextBox ID="txtFabricationDate" runat="server" ClientIDMode="Static" 
                                                            
                                                            
                        onclick="alert(getId('txtFabricationDate')))" Width="156px"></asp:TextBox>
                                                        <asp:Image ID="image3" runat="server" ImageUrl="~/Images/Calendar.png" 
                                                            meta:resourcekey="Image1Resource1" 
                                                            onclick="getPosition(this.id),getId('txtFabricationDate')" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                <td>
                    &nbsp;</td>
                <td class="style29">
                    <asp:Label ID="Label47" runat="server" Text="ያመረተው ካምፓኒ/ያዘጋጀው አካል: "></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtFabricationCampany" runat="server" Width="176px"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" 
                        Width="367px" Height="31px"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                <td>
                    &nbsp;</td>
                <td class="style29">
                    <asp:Label ID="Label49" runat="server" Text="የመዝግበው ንብረት አስተዳደር ስም፡"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtStorKeeperName" runat="server" Enabled="False" 
            ...
            <tr>
                ...
                <td class="style29">
                    &nbsp;</td>
                <td>
                    <asp:Button ID="btnClear" runat="server" onclick="btnClear_Click1" Text="አጽዳ" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnSave" runat="server" onclick="btnSave_Click" Text="መዝግብ" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td class="style29">
                    &nbsp;</td>
                <td>
                    &nbsp;<asp:ListBox ID="lbxQusaqusInformation" runat="server" 
                        AutoPostBack="True" 
                        onselectedindexchanged="lbxQusaqusInformation_SelectedIndexChanged" 
